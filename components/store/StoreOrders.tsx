...
export default function StoreOrders({ storeOrders }: { storeOrders: Order[] }) {
                ...
                >
                  ...
                  >
                    <select
                      ...
                      className="p-1 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-md text-sm focus:ring focus:ring-blue-200 dark:focus:ring-blue-900"
                    >
