      ...
      {!alreadySubmitted ? (
        <div className="mx-6 min-h-[70vh] my-16">
          ...
          >
            ...
            <button className="bg-slate-800 dark:bg-green-600 text-white px-12 py-2 rounded mt-10 mb-40 active:scale-95 hover:bg-slate-900 dark:hover:bg-green-700 transition">
              Submit
            </button>
          </form>
        </div>
